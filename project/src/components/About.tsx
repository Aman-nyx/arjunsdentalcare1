          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center bg-gray-50 p-6 rounded-lg">
                <Users className="w-8 h-8 text-[#7DD3FC] mx-auto mb-2" />
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <div className="flex items-center mb-2">
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">Afsal Vinod</p>
                      <div className="flex text-yellow-400">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className="w-3 h-3 fill-current" />
                        ))}
                  ...
                  <p className="text-gray-600 text-sm">
                    "The efficiency and performance created by the dentist is well clear and awesome. As it is a 24 hr dental clinic, it's a huge accomplishment."
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600 text-sm">
                    "We were looking for dental doctors at night and discovered this specialty care, which is open 24 hours. We were happy with the care offered."
                  </p>
                </div>
              </div>
            </div>
